...
public final class ExpoNotificationActions$Database extends BaseDatabaseDefinition {
  ...
  public ExpoNotificationActions$Database(DatabaseHolder holder) {
    ...
    holder.putDatabaseForTable(expo.modules.notifications.ActionObject.class, this);
    ...
    models.add(expo.modules.notifications.ActionObject.class);
    modelTableNames.put("ActionObject", expo.modules.notifications.ActionObject.class);
    modelAdapters.put(expo.modules.notifications.ActionObject.class, new expo.modules.notifications.ActionObject$Adapter());
